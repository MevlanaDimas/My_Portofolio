...
<body class="bg-stone-800">
                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-stone-800 shadow-lg rounded-lg max-w-[453px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="/login" class="text-base text-par py-2 mx-8 flex group-hover:text-secondary">Login</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <!-- Form regsiter section start -->
    <section class="mt-50 mb-30">
        <div class="container">
            <form action="register" method="post">
                @csrf
                <div class="w-2/3 flex flex-wrap justify-center mx-auto">
                    <div class="mb-12 p-4">
                        <div class="rounded-md shadow-md bg-gray-700 p-3 pb-1">
                            <h3 class="font-bold text-3xl text-par text-center items-center justify-center pb-4 mt-10 mb-8">Register</h3>
                            <div class="w-full px-4 mb-8">
                                <label for="email" class="text-sm font-bold text-primary">Name</label>
                                <input type="text" name="name" id="name" placeholder="Your Name" value="{{ old('email') }}" autofocus required class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            <div class="w-full px-4 mb-8">
                                <label for="email" class="text-sm font-bold text-primary">Email</label>
                                <input type="email" name="email" id="email" placeholder="name@example.com" value="{{ old('email') }}" autofocus required class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            <div class="w-full px-4 mb-8">
                                <label for="password" class="text-sm font-bold text-primary">Password</label>
                                <input type="password" name="password1" id="password1" placeholder="Enter your password" required class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            <div class="w-full px-4 mb-8">
                                <label for="password" name="password" id="password" placeholder="Re-Enter your password" required class="text-sm font-bold text-primary">Re-Type Password</label>
                                <input name="password2" id="password2" type="password" class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            @if($errors->any())
                                <div class="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800" role="alert">
                                    <svg width="50px" class="shrink-0 inline me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            @endif
                            <div class="w-full px-4 mb-8">
                                <button type="submit" class="text-sm font-semibold text-par bg-zinc-700 py-3 px-8 rounded-full w-full hover:shadow-lg transition duration-500">Regist</button>
                            </div>
                            <div class="w-full px-4 mb-8 justify-center content-center items-center text-center">
                                <a href="/login" class="register text-primary underline text-xs">Have account?</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Form register section end -->

    <!-- Footer section start -->
    <footer class="bg-stone-900 pt-5 w-full">
        <div class="container">
            <div class="pt-3 flex items-center justify-center mt-1 mb-5">

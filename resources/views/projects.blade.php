        ...
        <div class="container place-content-center">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4">
                    <h1 class="pb-5 block font-bold text-primary text-center items-center justify-center text-4xl mt-1 lg:text-5xl">Projects</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="w-full px-4 flex flex-wrap justify-center xl:w-6/10 xl:mx-auto">
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden items-center justify-center">
                        @foreach ($projects as $project)
                            <img src="{{ asset('storage/images/' . $project->img) }}" alt="Project Picture">
                            <h3 class="font-semibold text-xl text-gray-700 pl-5 pr-5 mt-2">{{ $project->title }}</h3>
                            <p class="font-medium text-base text-gray-900 pl-5 pr-5 pt-5">{{ $project->proj_desc }}</p>
                            <div class="m-5">
                                <span class="block flex">
                                    <ul>
                                        <li class="pt-5">
                                            ...
                                            <a href="{{ $project->web }}" class="text-button text-base">{{ $project->web }}</a>
                                        </li>
                                        <li class="pt-5">
                                            ...
                                            <a href="{{ $project->github }}" class="text-button text-base">{{ $project->github }}</a>
                                        </li>
                                    </ul>
                                </span>
                                <span class="block flex pt-5">
                                    <ul class="text-par mr-3">
                                        <li>
                                            <a href="{{ url('/project/'.$project->id.'/editProject') }}" class="inline-block text-base rounded-md bg-button transition duration-500 hover:shadow-md hover:bg-gray-500 hover:text-gray-800 px-4 py-2">Edit</a>
                                        </li>
                                    </ul>
                                    <ul class="text-par ml-3">
                                        <li>
                                            <a href="{{ url('/projects/'.$project->id.'/deleteProject') }}" class="inline-block text-base rounded-md bg-button transition duration-500 hover:shadow-md hover:bg-gray-500 hover:text-gray-800 px-4 py-2">Delete</a>
                                        </li>
                                    </ul>
                                </span>
                            </div>

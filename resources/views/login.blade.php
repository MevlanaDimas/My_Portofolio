                ...
                <div class="w-2/3 flex flex-wrap justify-center mx-auto">
                    <div class="mb-12 p-4">
                        <div class="rounded-md shadow-md bg-gray-700 p-3 pb-1">
                            <h3 class="font-bold text-3xl text-par text-center items-center justify-center pb-4 mt-10 mb-8">Login</h3>
                            ...
                            @endif
                            <div class="w-full px-4 mb-8">
                                <button type="submit" class="text-sm font-semibold text-par bg-zinc-700 py-3 px-8 rounded-full w-full hover:shadow-lg transition duration-500">Login</button>
                            </div>
                            ...
                            <div class="w-full px-4 mb-8 justify-center content-center items-center text-center">
                                <a href="/forgot-password" class="register text-primary underline text-xs">Forgot password?</a>
                            </div>
                        </div>
                    </div>
                </div>

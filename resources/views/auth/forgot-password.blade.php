                ...
                <div class="w-2/3 flex flex-wrap justify-center mx-auto">
                    <div class="mb-12 p-4">
                        <div class="rounded-md shadow-md bg-gray-700 p-3 pb-1">
                            <h3 class="font-bold text-3xl text-par text-center items-center justify-center pb-4 mt-10 mb-8">Forgot Password</h3>
                            ...
                            <div class="w-full px-4 mb-8">
                                <button type="submit" class="text-sm font-semibold text-par bg-zinc-700 py-3 px-8 rounded-full w-full hover:shadow-lg transition duration-500">Send</button>
                            </div>

                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-stone-800 shadow-lg rounded-lg max-w-[453px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="/register" class="text-base text-par py-2 mx-8 flex group-hover:text-secondary">Register</a>
                            </li>
                            <li class="group">
                ...
                <div class="w-2/3 flex flex-wrap justify-center mx-auto">
                    <div class="mb-12 p-4">
                        <div class="rounded-md shadow-md bg-gray-700 p-3 pb-1">
                            <h3 class="font-bold text-3xl text-par text-center items-center justify-center pb-4 mt-10 mb-8">Reset Password</h3>
                            ...
                            <div class="w-full px-4 mb-8">
                                ...
                                <input type="password" name="password" id="password" placeholder="Enter your password" required class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            <div class="w-full px-4 mb-8">
                                <label for="password_confirmation" class="text-sm font-bold text-primary">Re-Type Password</label>
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Re-Enter your password" required class="w-full mt-2 bg-stone-400 text-gray-950 p-3 rounded-md focus:outline-none focus:ring-gray-50 focus:ring-1 focus:border-rose-350">
                            </div>
                            <div class="w-full px-4 mb-8">
                                <input type="hidden" id="token" name="token" value="{{ $token }}" required>
                            </div>
                            <div class="w-full px-4 mb-8">
                                <button type="submit" class="text-sm font-semibold text-par bg-zinc-700 py-3 px-8 rounded-full w-full hover:shadow-lg transition duration-500">Submit</button>
                            </div>
                            <div class="w-full px-4 mb-8 justify-center content-center items-center text-center">
                                <a href="/register" class="register text-primary underline text-xs">Don't have account?</a>
                            </div>
                        </div>
                    </div>
                    @if($errors->any())

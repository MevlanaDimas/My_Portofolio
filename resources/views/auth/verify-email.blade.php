...
<body class="bg-stone-800">
    ...
    <section class="pt-36">
        <div class="h-full container place-content-center my-25 self-center">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4">
                    <h1 class="pb-5 block font-bold text-primary text-center items-center justify-center text-4xl mt-1 lg:text-5xl">Your Email Verification Link Already Send Your Email</h1>
                </div>
                    ...
                    <div class="mb-12 p-4">
                        <div class="rounded-md shadow-md bg-gray-700 p-3 pb-1">
                            <form action="/email/verification-notification" method="post">
                                @csrf
                                <button type="submit" class="ext-sm font-semibold text-par bg-zinc-700 py-3 px-8 rounded-full w-full hover:shadow-lg transition duration-500">Resend</button>
                            </form>
                        </div>
                    </div>
                </div>

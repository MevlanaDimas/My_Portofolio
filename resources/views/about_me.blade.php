                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-stone-800 shadow-lg rounded-lg max-w-[453px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="/about/createAbout" class="text-base text-par py-2 mx-8 flex group-hover:text-secondary">Create About Me</a>
                            </li>
                            <li class="group">
        ...
        <div class="container place-content-center">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4">
                    <h1 class="pb-5 block font-bold text-primary text-center items-center justify-center text-4xl mt-1 lg:text-5xl">About Me</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden items-center justify-center">
                        @foreach ($abouts as $about)
                            <img src="{{ asset('storage/photos/' . $about->photo) }}" alt="Photo" class="justify-center items-center self-center object-center content-center place-items-center place-content-center">
                            <p class="font-medium text-base text-gray-900 pl-5 pr-5 pt-5">{{ $about->bio }}</p>
                            <div class="m-5 flex">
                                <span class="block flex">
                                    <ul class="text-par mr-3">
                                        <li>
                                            <a href="{{ url('/about/'.$about->id.'/editAbout') }}" class="inline-block text-base rounded-md bg-button transition duration-500 hover:shadow-md hover:bg-gray-500 hover:text-gray-800 px-4 py-2">Edit</a>
                                        </li>
                                    </ul>
                                    <ul class="text-par ml-3">
                                        <li>
                                            <a href="{{ url('/about/'.$about->id.'/deleteAbout') }}" class="inline-block text-base rounded-md bg-button transition duration-500 hover:shadow-md hover:bg-gray-500 hover:text-gray-800 px-4 py-2">Delete</a>
                                        </li>
                                    </ul>
                                </span>
                            </div>
